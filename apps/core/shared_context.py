def external_links(request):
    return {
        "links": {
            "project_delivery_hub": "https://mhclg.sharepoint.com.mcas.ms/sites/ProjectDeliveryNetwork/SitePages/Project-Delivery-HUB.aspx",
            "finance_business_partner_email": "fbp@communities.gov.uk",
